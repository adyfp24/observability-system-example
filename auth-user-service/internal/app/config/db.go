...
import (
	...
	model "github.com/adyfp24/okejek-go-service/auth-user-service/internal/modules/user/core/entity"
...
func InitDB(cfg *Config) *gorm.DB {
	...
	if err := db.AutoMigrate(&model.User{}, &model.Driver{}); err != nil {
