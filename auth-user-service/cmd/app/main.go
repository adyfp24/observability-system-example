...
import (
	...
	"github.com/adyfp24/okejek-go-service/auth-user-service/internal/app/http"
	_ "github.com/joho/godotenv/autoload"
)

func main() {
	shutdown := telemetry.Init("auth-user-service")
	defer func() {
	...
	port := cfg.GetInt("APP_PORT", 3003)
	log.Printf("Server auth_user_service starting on port %d", port)
